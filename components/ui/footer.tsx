        ...
        <footer className="bg-gradient-to-br from-slate-900 to-slate-800 text-white mt-auto">
            <div className="container mx-auto px-4 py-4 md:py-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Business Info */}
                    <div>
                        <h3 className="text-xl font-bold mb-2 bg-gradient-to-r from-sky-400 to-violet-400 bg-clip-text text-transparent">
                            {BUSINESS_INFO.name}
                        </h3>
                    ...
                    <div>
                        ...
                        <div className="mt-3">
                            ...
                            <a
                                ...
                                className="text-slate-300 text-xs hover:text-sky-400 transition-colors block"
                            >
                    ...
                    <div>
                        ...
                        <div className="mt-3">
                            <Link
                                href="/contacto"
                                className="inline-block px-3 py-1.5 bg-gradient-to-r from-sky-500 to-violet-500 hover:from-sky-600 hover:to-violet-600 rounded-lg text-xs font-semibold transition-all"
                            >
                                Más Info
                            </Link>
                        </div>
